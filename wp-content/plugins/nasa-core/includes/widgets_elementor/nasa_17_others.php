    ...
    function __construct() {
        ...
        $this->settings = array(
            ...
            'show_mini_cart' => array(
                ...
                'label' => esc_html__('Cart', 'nasa-core')
            ),
            ...
            'show_mini_compare' => array(
                ...
                'std' => 'yes',
                'options' => $this->array_bool_YN(),
                'label' => esc_html__('Compare', 'nasa-core')
            ),
            ...
            'show_mini_wishlist' => array(
                ...
                'std' => 'yes',
                'options' => $this->array_bool_YN(),
                'label' => esc_html__('Wishlist', 'nasa-core')
            ),
...
class Nasa_Search_Products_WGSC extends Nasa_Elementor_Widget {
    ...
    function __construct() {
        ...
        $this->widget_description = esc_html__('Live search products', 'nasa-core');
        $this->widget_id = 'nasa_sc_search_form';
        $this->widget_name = esc_html__('Nasa Header Search', 'nasa-core');
        $this->settings = array(
            'el_class' => array(
                'type' => 'text',
                'std' => '',
