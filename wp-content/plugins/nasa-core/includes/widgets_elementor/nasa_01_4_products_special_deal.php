    ...
    function __construct() {
        ...
        $this->settings = array(
            ...
            'style' => array(
                ...
                'options' => array(
                    'simple' => esc_html__('Simple Deals', 'nasa-core'),
                    ...
                    'for_time-2' => esc_html__('Deal Before Time V2', 'nasa-core')
                )
            ),
            ...
            'title_align' => array(
                'type' => 'select',
                'std' => '0',
                'label' => esc_html__('Title Centered - For Deal Before Time V2', 'nasa-core'),
            ...
            'arrows_pos' => array(
                'type' => 'select',
                'std' => '0',
                'label' => esc_html__('Arrows Position - Simple Deals', 'nasa-core'),
                'options' => array(
                    '0' => esc_html__('Top', 'nasa-core'),
                    '1' => esc_html__('Side', 'nasa-core')
                )
            ),
