...
class Nasa_Image_Box_Grid_WGSC extends Nasa_Elementor_Widget {
    ...
    function __construct() {
        ...
        $this->widget_description = esc_html__('Displays Shortcode Nasa Image Box Grid', 'nasa-core');
        $this->widget_id = 'nasa_image_box_grid_sc';
        $this->widget_name = esc_html__('Nasa Image Box Grid', 'nasa-core');
        $this->settings = array(
            'title' => array(
                'type' => 'text',
                'std' => '',
            ...
            'title_font_size' => array(
                'type' => 'select',
                'std' => 'm',
                'label' => esc_html__('Title Font Size', 'nasa-core'),
                'options' => array(
                    'xl' => esc_html__('X-Large', 'nasa-core'),
                    'l' => esc_html__('Large', 'nasa-core'),
                    'm' => esc_html__('Medium', 'nasa-core'),
                    's' => esc_html__('Small', 'nasa-core'),
                    't' => esc_html__('Tiny', 'nasa-core')
                )
            ),
            ...
            'glb_link' => array(
                'type' => 'text',
                'std' => '',
                'label' => esc_html__('Global URL', 'nasa-core')
            ),
            
            'glb_link_text' => array(
                'type' => 'text',
                'std' => 'See All&nbsp;<i class="fa fa-arrow-circle-right primary-color"></i>',
                'label' => esc_html__('Global URL Text', 'nasa-core')
            ),
            
            'boxgrid' => array(
                'type' => 'boxgrid',
                'std' => array(),
                'label' => esc_html__('Image Box Items', 'nasa-core')
            ),
        ...
        $this->settings_item = array(
            ...
            'alt' => array(
                'type' => 'text',
                'std' => '',
                'label' => esc_html__('ALT - Text', 'nasa-core')
            ),
            ...
            'link_target' => array(
                'type' => 'select',
                'std' => '',
                'label' => esc_html__('Target', 'nasa-core'),
                'options' => array(
                    '' => esc_html__('Default', 'nasa-core'),
                    '_blank' => esc_html__('Blank', 'nasa-core')
                )
            ),
