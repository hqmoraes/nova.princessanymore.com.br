    ...
    vc_map(array(
        ...
        "params" => array(
            ...
            array(
                ...
                "param_name" => "style",
                "value" => array(
                    esc_html__('Simple Deals', 'nasa-core') => 'simple',
                    ...
                    esc_html__('Deal Before Time V2', 'nasa-core') => 'for_time-2'
                ),
                'std' => 'simple',
                "admin_label" => true,
            ),
            ...
            array(
                "type" => "dropdown",
                "heading" => esc_html__("Title Centered - For Deal Before Time V2", 'nasa-core'),
            ...
            array(
                "type" => "dropdown",
                "heading" => esc_html__('Arrows Position - Simple Deals', 'nasa-core'),
                "param_name" => 'arrows_pos',
                "value" => array(
                    esc_html__('Top', 'nasa-core') => '0',
                    esc_html__('Side', 'nasa-core') => '1'
                ),
                "std" => '0'
            ),
