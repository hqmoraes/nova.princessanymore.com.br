...
function nasa_register_product_categories_2(){
    $params = array(
        ...
        'description' => esc_html__("Display Child of Product Categories.", 'nasa-core'),
        "category" => "Nasa Core",
        "params" => array(
            array(
                "type" => "dropdown",
                "heading" => esc_html__("Root Product Category", 'nasa-core'),
                "param_name" => "root_cat",
                "admin_label" => true,
            ...
            array(
                "type" => "textfield",
                "heading" => esc_html__('Limit Child Items to display', 'nasa-core'),
                "param_name" => 'number',
                "value" => '7'
            ),
            ...
            array(
                "type" => "dropdown",
                "heading" => esc_html__('Order By', 'nasa-core'),
                "param_name" => 'orderby',
                "value" => array(
                    esc_html__('Menu Order', 'nasa-core') => 'menu_order',
                    esc_html__('Name', 'nasa-core') => 'name'
                ),
                "std" => 'menu_order'
            ),
