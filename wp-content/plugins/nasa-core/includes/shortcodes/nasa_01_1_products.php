    ...
    vc_map(array(
        ...
        "params" => array(
            array(
                ...
                "description" => esc_html__("Only using for Style is Slider, Simple Slide, Slider - Widget Items.", 'nasa-core')
            ),
            ...
            array(
                ...
                "value" => array(
                    ...
                    esc_html__('Quantity Stock') => 'stock_desc'
                ),
                'std' => 'recent_product',
                "admin_label" => true
            ),
            ...
            array(
                ...
                "value" => array(
                    ...
                    esc_html__('Simple Slider v2', 'nasa-core') => 'slide_slick_2',
