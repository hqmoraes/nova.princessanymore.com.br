...
if (NASA_WOO_ACTIVED) {
    ...
    class Nasa_Products_Widget extends WC_Widget {
        ...
        public function __construct() {
            ...
            $this->widget_description = esc_html__('Display products list.', 'nasa-core');
            $this->widget_id = 'nasa_products_widget';
            $this->widget_name = esc_html__('Nasa Products Widget', 'nasa-core');
            $this->settings = array(
                'title' => array(
                    'type' => 'text',
                    'std' => esc_html__('Products', 'nasa-core'),
