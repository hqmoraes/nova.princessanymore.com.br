...
function nasa_vc_setup() {
    ...
    if (class_exists('WPBakeryShortCodesContainer')) {
        // Allow add Element for Shortcode Nasa Slider
        class WPBakeryShortCode_nasa_slider extends WPBakeryShortCodesContainer {}
        
        // Allow add Element for Shortcode Nasa Image Box Grid
        class WPBakeryShortCode_nasa_image_box_grid extends WPBakeryShortCodesContainer {}
    }
