...
class Nasa_WC_Attr_UX extends Nasa_Abstract_WC_Attr_UX {
    ...
    public function nasa_custom_variation($variation, $variable_product, $variation_product) {
        ...
        if ("outofstock" === $variation_product->get_stock_status()) {
            $variation['outofstock_badge'] = function_exists('elessi_badge_outofstock') ? elessi_badge_outofstock() : apply_filters('nasa_badge_outofstock', '<span class="badge out-of-stock-label">' . esc_html__('Sold Out', 'nasa-core') . '</span>');
        }
