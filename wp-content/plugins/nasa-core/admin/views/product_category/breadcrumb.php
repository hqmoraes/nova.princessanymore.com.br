...
if (is_object($term) && $term) {
    ...
    $image_m = $thumbnail_m_id ? wp_get_attachment_thumb_url($thumbnail_id) : wc_placeholder_img_src();
    ...
    ?>
    <tr class="form-field breadcrumb_allow nasa-term-root hidden-tag">
        <th scope="row" valign="top">
            <label for="<?php echo $this->_cat_bread_allow; ?>"><?php _e('Show Breadcrumb', 'nasa-core'); ?></label>
        </th>
        ...
        <td>
            <div class="nasa_breadcrumb_allow">
                <select name="<?php echo $this->_cat_bread_allow; ?>" id="<?php echo $this->_cat_bread_allow; ?>" class="postform">
                    ...
                    <option value="-1"<?php echo $bread_allow == '-1' ? ' selected' : ''; ?>><?php echo esc_html__('No, Thank!', 'nasa-core'); ?></option>
                </select>
            </div>
            <div class="clear"></div>
        </td>
    ...
    <tr class="form-field breadcrumb_layout nasa-term-root hidden-tag">
        <th scope="row" valign="top">
    ...
    <tr class="form-field breadcrumb_type nasa-term-root hidden-tag">
        <th scope="row" valign="top">
    ...
    <tr class="form-field with-breadcrumb_type nasa-term-root hidden-tag">
        <th scope="row" valign="top">
            <label><?php _e('Background Image Breadcrumb', 'nasa-core'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field nasa-term-root hidden-tag">
        <th scope="row" valign="top">
            <label for="<?php echo $this->_cat_bread_bg_color; ?>"><?php _e('Background Color Breadcrumb', 'nasa-core'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field nasa-term-root hidden-tag">
        <th scope="row" valign="top">
            <label for="<?php echo $this->_cat_bread_text; ?>"><?php _e('Text Color Breadcrumb', 'nasa-core'); ?></label>
        </th>
        <td>
            <div class="nasa_p_color">
 ...
 */
    ...
    <div class="form-field term-breadcrumb_allow-wrap nasa-term-root hidden-tag">
        <label for="<?php echo $this->_cat_bread_allow; ?>"><?php _e('Show Breadcrumb', 'nasa-core'); ?></label>
        <div class="nasa_breadcrumb_allow">
            <select name="<?php echo $this->_cat_bread_allow; ?>" id="<?php echo $this->_cat_bread_allow; ?>" class="postform">
                <option value=""><?php echo esc_html__('Default', 'nasa-core'); ?></option>
                <option value="1"><?php echo esc_html__('Yes, Please!', 'nasa-core'); ?></option>
                <option value="-1"><?php echo esc_html__('No, Thank!', 'nasa-core'); ?></option>
            </select>
        </div>
        <div class="clear"></div>
    </div>
    
    <div class="form-field term-breadcrumb_layout-wrap nasa-term-root hidden-tag">
        <label for="<?php echo $this->_cat_bread_layout; ?>"><?php _e('Breadcrumb Layout', 'nasa-core'); ?></label>
        <div class="nasa_breadcrumb_layout">
            <select name="<?php echo $this->_cat_bread_layout; ?>" id="<?php echo $this->_cat_bread_layout; ?>" class="postform">
                <option value=""><?php echo esc_html__('Default', 'nasa-core'); ?></option>
    ...
    <div class="form-field term-breadcrumb_type-wrap nasa-term-root hidden-tag">
        <label for="<?php echo $this->_cat_bread_enable; ?>"><?php _e('Breadcrumb type', 'nasa-core'); ?></label>
        <div class="nasa_breadcrumb_type">
            <select name="<?php echo $this->_cat_bread_enable; ?>" id="<?php echo $this->_cat_bread_enable; ?>" class="postform">
                <option value=""><?php echo esc_html__('Default', 'nasa-core'); ?></option>
    ...
    <div class="form-field term-breadcrumb_bg-wrap with-breadcrumb_type nasa-term-root hidden-tag">
    ...
    <div class="form-field term-breadcrumb_bg_color-wrap nasa-term-root hidden-tag">
        <label><?php _e('Background color breadcrumb', 'nasa-core'); ?></label>
        <div class="nasa_p_color">
    ...
    <div class="form-field term-breadcrumb_text_color-wrap nasa-term-root hidden-tag">
    ...
    <div class="form-field term-breadcrumb_align-wrap nasa-term-root hidden-tag">
        <label for="<?php echo $this->_cat_bread_align; ?>"><?php _e('Breadcrumb Text Alignment', 'nasa-core'); ?></label>
        <div class="nasa_breadcrumb_type">
            <select name="<?php echo $this->_cat_bread_align; ?>" id="<?php echo $this->_cat_bread_align; ?>" class="postform">
                <option value=""><?php echo esc_html__('Default', 'nasa-core'); ?></option>
    ...
    <div class="form-field term-breadcumb_height-wrap nasa-term-root hidden-tag">
	<label for="<?php echo $this->_cat_bread_height; ?>"><?php _e('Breadcrumb Height', 'nasa-core'); ?></label>
