...
if (is_object($term) && $term) {
        ...
        <td>
            <div class="nasa_width_more_allow">
                <select name="<?php echo $this->_cat_width_more_allow; ?>" id="<?php echo $this->_cat_width_more_allow; ?>" class="postform">
                    ...
                    <option value="-1"<?php echo $cat_width_allow == -1 ? ' selected' : ''; ?>><?php echo esc_html__('No, Thank!', 'nasa-core'); ?></option>
                </select>
            </div>
            <div class="clear"></div>
        </td>
    ...
    <tr class="form-field nasa-term-root-child <?php echo $this->_cat_width_more_allow . ' nasa-term-' . $this->_cat_width_more_allow . '-1'; ?> hidden-tag">
        <th scope="row">
    ...
    ?>
    <div class="form-field term-width_more_allow-wrap nasa-term-root hidden-tag">
        <label for="<?php echo $this->_cat_width_more_allow; ?>"><?php _e('Custom Width', 'nasa-core'); ?></label>
        <div class="nasa_width_more_allow">
            <select name="<?php echo $this->_cat_width_more_allow; ?>" id="<?php echo $this->_cat_width_more_allow; ?>" class="postform">
    ...
    <div class="form-field term-more_width-wrap nasa-term-root-child <?php echo $this->_cat_width_more_allow . ' nasa-term-' . $this->_cat_width_more_allow . '-1'; ?> hidden-tag">
