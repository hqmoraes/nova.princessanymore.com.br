...
function nasa_single_product_layouts() {
    $options = array(
        ""          => esc_html__("Default", 'nasa-core'),
        "classic"   => esc_html__("Classic", 'nasa-core'),
        "new"       => esc_html__("New", 'nasa-core'),
        "new-2"     => esc_html__("New Type 2", 'nasa-core'),
        "full"      => esc_html__("Slider - Fullwidth", 'nasa-core'),
        "modern-1"  => esc_html__("Purchase Focus", 'nasa-core'),
    );
...
function nasa_single_product_sidebars() {
    $options = array(
        ""        => esc_html__("Default", 'nasa-core'),
        "left"    => esc_html__("Left Sidebar", 'nasa-core'),
        "right"   => esc_html__("Right Sidebar", 'nasa-core'),
        "no"      => esc_html__("No Sidebar", 'nasa-core'),
    );
...
function nasa_single_product_tabs_style() {
    $options = array(
        ...
        "small-accordion"   => esc_html__("Accordion in Content", 'nasa-core'),
...
function nasa_product_hover_effect_types() {
    $options = array(
        ...
        "hover-carousel"        => esc_html__("Gallery - Carousel", 'nasa-core'),
