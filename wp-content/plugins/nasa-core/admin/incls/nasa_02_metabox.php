...
function nasa_meta_boxes(array $meta_boxes) {
    ...
    $meta_boxes['nasa_metabox_general'] = array(
        ...
        'fields' => array(
            ...
            array(
                'name' => esc_html__('Background Mode', 'nasa-core'),
            ...
            array(
                'name' => esc_html__('Product Card Styles', 'nasa-core'),
            ...
            array(
                "name" => esc_html__("Extra Class Page", 'nasa-core'),
                'desc' => esc_html__('Add Custom Class Page', 'nasa-core'),
    ...
    $meta_boxes['nasa_metabox_font'] = array(
        ...
        'fields' => array(
            ...
            array(
                'name' => esc_html__('Font-Weight', 'nasa-core'),
    ...
    $meta_boxes['nasa_metabox_header'] = array(
        ...
        'fields' => array(
            ...
            array(
                'name' => esc_html__('Vertical Menu Background - Focus', 'nasa-core'),
                'desc' => esc_html__('Override Vertical Menu Background - Focus', 'nasa-core'),
                'id' => $prefix . 'bg_color_v_menu',
                'type' => 'colorpicker',
                'default' => '',
                'class' => 'nasa-option-color hidden-tag nasa-core-option-child core' . $prefix . 'custom_header core' . $prefix . 'custom_header-4'
            ),
            
            array(
                'name' => esc_html__('Vertical Menu Text Color - Focus', 'nasa-core'),
                'desc' => esc_html__('Override Vertical Menu Text Color - Focus', 'nasa-core'),
    ...
    $meta_boxes['nasa_metabox_breadcrumb'] = array(
        ...
        'fields' => array(
            ...
            array(
                'name' => esc_html__('Breadcrumb Layout', 'nasa-core'),
                'id' => $prefix . 'layout_breadcrumb',
                'type' => 'select',
                'options' => array(
                    '' => esc_html__('Default', 'nasa-core'),
                    'multi' => esc_html__('Double Rows', 'nasa-core'),
                    'single' => esc_html__('Single Row', 'nasa-core')
                ),
                'default' => '',
            ...
            array(
                ...
                'options' => array(
                    '' => esc_html__('Default', 'nasa-core'),
                    '1' => esc_html__('With Background', 'nasa-core'),
                    '-1' => esc_html__('Without Background', 'nasa-core')
                ),
                'default' => '',
            ...
            array(
                'name' => esc_html__('Text Alignment', 'nasa-core'),
