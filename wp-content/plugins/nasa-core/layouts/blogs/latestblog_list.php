<?php if ($count = wp_count_posts()->publish):
    ...
    $class_info = 'post-content info-wrap mobile-padding-top-20 large-9 columns rtl-right';
    ...
    <div class="nasa-blog-sc nasa-sc-blogs-list nasa-blog-wrap-all-items">
        <?php while($recentPosts->have_posts()) :
            ...
            ?>
            <div class="row blog-item nasa-sc-blogs-row wow fadeInUp" data-wow-duration="1s" data-wow-delay="<?php echo esc_attr($_delay); ?>ms">
                ...
                <div class="<?php echo esc_attr($class_info); ?>">
                    ...
                    <a class="nasa-blog-title nasa-bold-700" href="<?php echo esc_url($link); ?>" title="<?php echo esc_attr($title); ?>">
                        <?php echo $title;?>
                    </a>
