...
/**
 * re-fix sticky add to cart price with Bulk Discount
 */
//var _fixed_old_price = false;
//$('body').on('change', 'form.cart input[name="quantity"]', function() {
//    if ($('.nasa-add-to-cart-fixed .nasa-title-clone > .price').length) {
//        setTimeout(function() {
//            if (!_fixed_old_price) {
//                _fixed_old_price = $('.nasa-add-to-cart-fixed .nasa-title-clone .price > .woocommerce-Price-amount').clone();
//            }
//            
//            if ($('.nasa-product-details-page .price.nasa-bulk-price .bulk-price > .woocommerce-Price-amount').length) {
//
//                var _new_price = $('.nasa-product-details-page .price.nasa-bulk-price .bulk-price > .woocommerce-Price-amount').clone();
//
//                $('.nasa-add-to-cart-fixed .nasa-title-clone > .price').html('');
//                $('.nasa-add-to-cart-fixed .nasa-title-clone > .price').append(_new_price);
//            } else {
//                $('.nasa-add-to-cart-fixed .nasa-title-clone > .price').html('');
//                $('.nasa-add-to-cart-fixed .nasa-title-clone > .price').append(_fixed_old_price);
//            }
//        }, 10);
//    }
//});
