            ...
            <tbody>
                <?php if ($countItems > 0) :
                    ...
                    <tr class="pagination-row">
                        <td class="wishlist-empty"><p class="empty"><i class="nasa-empty-icon icon-nasa-like"></i><?php esc_html_e('Sem produtos favoritos', 'elessi-theme') ?><a href="javascript:void(0);" class="button nasa-sidebar-return-shop" rel="nofollow"><?php echo esc_html__('VOLTAR PARA A LOJA', 'elessi-theme'); ?></a></p></td>
                    </tr>
                <?php
                endif;
                ...
                <tr class="pagination-row">
                    <td class="wishlist-empty">
                        <p class="empty">
                            ...
                            <?php esc_html_e('Sem produtos favoritos.', 'elessi-theme') ?>
                            <a href="javascript:void(0);" class="button nasa-sidebar-return-shop" rel="nofollow"><?php echo esc_html__('VOLTAR PARA A LOJA', 'elessi-theme'); ?></a>
                        </p>
                    </td>
                </tr>
            <?php
