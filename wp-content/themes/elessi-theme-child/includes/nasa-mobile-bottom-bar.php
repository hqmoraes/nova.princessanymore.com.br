...
if (!$is_close) :
    $shop_link = NASA_WOO_ACTIVED ? wc_get_page_permalink('shop') : home_url('/');
    ...
    <ul class="nasa-bottom-bar-icons nasa-transition">
        <li class="nasa-bot-item">
            <a class="nasa-bot-icons nasa-bot-icon-shop" href="<?php echo esc_url($shop_link); ?>" title="<?php echo esc_attr__('Shop', 'elessi-theme'); ?>">
                <?php echo $icon_home; ?>
