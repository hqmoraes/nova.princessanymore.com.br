...
if(document.getElementById('cart-sidebar')){
    document.querySelector('.nasa-tit-mycart.nasa-sidebar-tit.text-center').innerText = 'Carrinho de Compras';
}
if(document.querySelector('.empty.woocommerce-mini-cart__empty-message')){
    document.querySelector('.empty.woocommerce-mini-cart__empty-message').innerText = 'Seu carrinho está vazio';
}