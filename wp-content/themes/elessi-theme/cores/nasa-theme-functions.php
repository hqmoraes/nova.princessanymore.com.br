...
if (!function_exists('elessi_bg_dark')) :
    function elessi_bg_dark() {
        ...
        if ($bg_version == 1) {
            ...
            wp_enqueue_style('elessi-dark-version', ELESSI_THEME_URI . '/assets/css/style-dark.css');
            
            if (isset($nasa_opt['transition_load']) && $nasa_opt['transition_load'] == 'crazy') {
                /**
                 * CSS Crazy Load Dark
                 */
                wp_enqueue_style('elessi-style-crazy-dark', ELESSI_THEME_URI . '/assets/css/style-crazy-load-dark.css');
            }
        }
        ...
        if ($bg_version == 2) {
            ...
            wp_enqueue_style('elessi-gray-version', ELESSI_THEME_URI . '/assets/css/style-gray.css');
        }
    }
endif;
