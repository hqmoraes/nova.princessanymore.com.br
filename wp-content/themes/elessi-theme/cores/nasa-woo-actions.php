...
if (!function_exists('elessi_loop_product_content_thumbnail')) :
    function elessi_loop_product_content_thumbnail() {
        ...
        if (!empty($gallery)) {
            ...
            $wrap_attrs[] = 'data-gellery="' . $gallery_json_str . '"';
        }
        
        $wrap = empty($gallery) ? 'a' : 'div';
        
        ?>
        <<?php echo $wrap; ?> <?php echo implode(' ', $wrap_attrs); ?>>
            <div class="main-img">
                <?php echo $main_img; ?>
            </div>
...
if (!function_exists('elessi_nasa_change_view')) :
    function elessi_nasa_change_view($nasa_sidebar = 'no') {
        ...
        $type_show = isset($_COOKIE[$grid_cookie_name]) ? $_COOKIE[$grid_cookie_name] : $type_show;
        ...
        <div class="<?php echo $class_wrap; ?>">
            ...
            <?php if (isset($nasa_opt['option_6_cols']) && $nasa_opt['option_6_cols']) : ?>
                <a href="javascript:void(0);" rel="nofollow" class="nasa-change-layout productGrid grid-6<?php echo ($type_show == 'grid-6') ? ' active' : ''; ?>" data-columns="6">
            ...
            <a href="javascript:void(0);" rel="nofollow"  class="nasa-change-layout productGrid grid-5<?php echo ($type_show == 'grid-5') ? ' active' : ''; ?>" data-columns="5">
                <?php if ($number_view) : ?>
                    <span class="nasa-text-number hidden-tag">
            ...
            <a href="javascript:void(0);" rel="nofollow" class="nasa-change-layout productGrid grid-4<?php echo ($type_show == 'grid-4') ? ' active' : ''; ?>" data-columns="4">
                <?php if ($number_view) : ?>
                    <span class="nasa-text-number hidden-tag">
            ...
            <a href="javascript:void(0);" rel="nofollow" class="nasa-change-layout productGrid grid-3<?php echo ($type_show == 'grid-3') ? ' active' : ''; ?>" data-columns="3">
                <?php if ($number_view) : ?>
                    <span class="nasa-text-number hidden-tag">
            ...
            <?php if (isset($nasa_opt['option_2_cols']) && $nasa_opt['option_2_cols']) : ?>
                <a href="javascript:void(0);" rel="nofollow" class="nasa-change-layout productGrid grid-2<?php echo ($type_show == 'grid-2') ? ' active' : ''; ?>" data-columns="2">
                    <?php if ($number_view) : ?>
                        <span class="nasa-text-number hidden-tag">
            ...
            <?php if ($list_view) : ?>
                <a href="javascript:void(0);" rel="nofollow" class="nasa-change-layout productList list<?php echo ($type_show == 'list') ? ' active' : ''; ?>" data-columns="1">
                    <?php if ($number_view) : ?>
                        <span class="nasa-text-number hidden-tag">
