...
if (!function_exists('elessi_get_style_vertical_menu_color')) :
    ...
    function elessi_get_style_vertical_menu_color(
        ...
        <?php if ($bg_color != '') : ?>
                ...
                body .nasa-vertical-header .vertical-menu-wrapper
                {
    ...
    function elessi_get_font_style_rtl (
        ...
        if ($type_font_select == 'custom' && $custom_font) :
            ?>
                ...
                {
                    font-family: "<?php echo esc_attr(ucwords($custom_font)); ?>";
                }
            <?php
        elseif ($type_font_select == 'google') :
            if ($type_headings != '') :
                ?>
                    ...
                    body.nasa-rtl h6
                    {
                        font-family: "<?php echo esc_attr($type_headings); ?>";
                    }
                <?php
            endif;
            ...
            if ($type_texts != '') :
                ?>
                    ...
                    body.nasa-rtl .top-bar-nav a.nav-top-link
                    {
                        font-family: "<?php echo esc_attr($type_texts); ?>";
                    }
                <?php
            endif;
            ...
            if ($type_nav != '') :
                ?>
                    ...
                    {
                        font-family: "<?php echo esc_attr($type_nav); ?>";
                    }
                <?php
            endif;
            ...
            if ($type_banner != '') :
                ?>
                    ...
                    body.nasa-rtl .nasa-banner h6
                    {
                        font-family: "<?php echo esc_attr($type_banner); ?>";
                        letter-spacing: 0px;
                    }
                <?php
            endif;
            ...
            if ($type_price != '') :
                ?>
                    ...
                    {
                        font-family: "<?php echo esc_attr($type_price); ?>";
                    }
                <?php
            endif;
        endif; ?></style><?php
    ...
    function elessi_get_font_style (
        ...
        if ($type_font_select == 'custom' && $custom_font) :
            ?>
                ...
                .nasa-banner h6
                {
                    font-family: "<?php echo esc_attr(ucwords($custom_font)); ?>"<?php echo $imprtant ? ' !important' : ''; ?>;
                }
            <?php
        elseif ($type_font_select == 'google') :
            if ($type_headings != '') :
                ?>
                    ...
                    h1, h2, h3, h4, h5, h6
                    {
                        font-family: "<?php echo esc_attr($type_headings); ?>"<?php echo $imprtant ? ' !important' : ''; ?>;
                    }
                <?php
            endif;
            ...
            if ($type_texts != '') :
                ?>
                    ...
                    .top-bar-nav a.nav-top-link
                    {
                        font-family: "<?php echo esc_attr($type_texts); ?>"<?php echo $imprtant ? ' !important' : ''; ?>;
                    }
                <?php
            endif;
            ...
            if ($type_nav != '') :
                ?>
                    ...
                    {
                        font-family: "<?php echo esc_attr($type_nav); ?>"<?php echo $imprtant ? ' !important' : ''; ?>;
                    }
                <?php
            endif;
            ...
            if ($type_banner != '') :
                ?>
                    ...
                    .nasa-banner h6
                    {
                        font-family: "<?php echo esc_attr($type_banner); ?>"<?php echo $imprtant ? ' !important' : ''; ?>;
                        letter-spacing: 0px;
                    }
                <?php
            endif;
            ...
            if ($type_price != '') :
                ?>
                    ...
                    .amount
                    {
                        font-family: "<?php echo esc_attr($type_price); ?>"<?php echo $imprtant ? ' !important' : ''; ?>;
                    }
                <?php
            endif;
        endif; ?></style><?php
...
if (!function_exists('elessi_add_dynamic_css')) :
    ...
    function elessi_add_dynamic_css() {
        ...
        if (is_file($dynamic_path . '/dynamic.css')) {
            ...
            // Dynamic Css
            wp_enqueue_style('elessi-style-dynamic', elessi_remove_protocol($nasa_upload_dir['baseurl']) . '/nasa-dynamic/dynamic.css', array(), $version, 'all');
        }
    }
...
if (!function_exists('elessi_page_override_style')) :
    function elessi_page_override_style() {
         ...
         */
        if ($font_weight != '') {
            wp_dequeue_style('elessi-style-font-weight');

            if (in_array($font_weight, array('800', '700', '600', '500'))) {
                wp_enqueue_style('elessi-font-weight-override', ELESSI_THEME_URI . '/assets/css/style-font-weight-' . $font_weight . '.css', array());
            }
        }
