...
<div class="<?php echo esc_attr($class_wrap_archive); ?>">
    ...
    <div class="large-12 columns">
        <div class="<?php echo esc_attr($topbarWrap_class); ?>">
            ...
            elseif ($topSidebar2) :
                ...
                <div class="large-4 columns hide-for-medium hide-for-small nasa-change-view-wrap text-center rtl-right">
                    <?php if ($nasa_change_view) : ?>
                        <?php
                        /**
                         * Change view ICONS
             ...
             */
                ...
                <div class="large-4 columns hide-for-medium hide-for-small nasa-change-view-layout-side-sidebar nasa-min-height<?php echo esc_attr($col_class); ?>">
                    <?php
                    if ($nasa_change_view) :
                        /**
                         * Change view ICONS
                ...
                <div class="large-4 medium-12 small-12 columns nasa-clear-none nasa-sort-bar-layout-side-sidebar<?php echo esc_attr($col_class); ?>">
    ...
    if ($nasa_ajax_product) :
        ...
        <div class="nasa-has-filter-ajax hidden-tag">
             ...
             * Current URL
             */
            echo '<input type="hidden" name="nasa_current-slug" id="nasa_current-slug" value="' . esc_url(elessi_get_origin_url()) . '" />';
