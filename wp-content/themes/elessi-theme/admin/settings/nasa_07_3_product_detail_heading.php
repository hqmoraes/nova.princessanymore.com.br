    ...
    function elessi_product_detail_heading() {
        ...
        /* $of_options[] = array(
            ...
            "options" => array(
                ...
                "new" => esc_html__("New", 'elessi-theme'),
                "new-2" => esc_html__("New Type 2", 'elessi-theme'),
                "full" => esc_html__("Slider - Fullwidth", 'elessi-theme'),
            ),
        ...
        $of_options[] = array(
            ...
            'class' => 'nasa-theme-option-parent flex-row flex-wrap flex-start img-max-height-150'
        );
        ...
        /* $of_options[] = array(
            ...
            "options" => array(
                ...
                "small-accordion" => esc_html__("Accordion in Content", 'elessi-theme'),
