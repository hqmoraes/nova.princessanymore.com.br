...
if (!function_exists('elessi_header_footer_heading')) {
    function elessi_header_footer_heading() {
        ...
        $of_options[] = array(
            "name" => esc_html__("The Block beside Main menu in Header Type 4", 'elessi-theme'),
            "desc" => esc_html__("Please Create Static Block to use.", 'elessi-theme'),
            "id" => "header-block-type_4",
            "type" => "select",
            "options" => $static_blocks,
            'class' => 'hidden-tag nasa-header-type-child nasa-header-type-select-4 nasa-header-block-type_4'
        );
        ...
        $of_options[] = array(
            ...
            "std" => "",
            "type" => "color",
            'class' => 'hidden-tag nasa-header-type-child nasa-header-type-select-4 nasa-bg_color_v_menu'
        );
        ...
        $of_options[] = array(
            ...
            "std" => "",
            "type" => "color",
            'class' => 'hidden-tag nasa-header-type-child nasa-header-type-select-4 nasa-text_color_v_menu'
        );
