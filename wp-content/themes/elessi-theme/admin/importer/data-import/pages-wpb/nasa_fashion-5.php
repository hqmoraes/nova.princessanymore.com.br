...
function nasa_wpb_fashion_5() {
    return array(
        'post' => array(
            ...
            'post_content' => '[vc_row el_class="desktop-margin-top-20 mobile-margin-top-10 mobile-margin-bottom-10"][vc_column width="2/3" el_class="nasa-min-height mobile-margin-bottom-10"][nasa_slider bullets="false" navigation="false" autoplay="true" el_class="right-now"][nasa_banner_2 align="right" text-align="text-right" img_src="3105" el_class="mobile-font-size-150"]
    <h4>Autumn
    &amp; Winter 2019</h4>
    <h5 style="color: #999;">Enjoy this fall trend</h5>
    [/nasa_banner_2][nasa_banner_2 img_src="3105" el_class="mobile-font-size-150"]
    <h4>New Arrival 2019</h4>
    <h5 style="color: #999;">Enjoy this fall trend</h5>
    [/nasa_banner_2][/nasa_slider][/vc_column][vc_column width="1/3"][nasa_banner_2 align="center" valign="bottom" text-align="text-center" effect_text="fadeInLeft" data_delay="400ms" img_src="3106"]
    <div>
    ...
    [/nasa_banner_2][/vc_column][/vc_row][vc_row][vc_column width="1/3"][nasa_banner_2 text_color="dark" effect_text="fadeInLeft" hover="zoom" data_delay="600ms" img_src="3108"]
    <h5 style="color: #333; font-weight: bold; font-size: 180%;">Flower Handbag</h5>
    <h6 style="color: #999;">Woman &amp; Bag</h6>
    [/nasa_banner_2][/vc_column][vc_column width="1/3"][nasa_banner_2 text_color="dark" effect_text="flipInX" hover="zoom" data_delay="600ms" img_src="3108"]
