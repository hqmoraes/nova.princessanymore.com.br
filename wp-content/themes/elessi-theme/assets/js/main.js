...
if (_hash) {
    ...
    if ($(_hash).length) {
        if (_hash === '#comments' && $('.woocommerce-review-link').length) {
            setTimeout(function() {
...
$('body').on('click', '.cart-link', function() {
    if ($('body').hasClass('woocommerce-cart') || $('body').hasClass('woocommerce-checkout') || $('form.woocommerce-cart-form').length || $('form.woocommerce-checkout').length) {
        return false;// Disable with shopping cart page and checkout page.
    } else {
 ...
 * Change language
 */
$('body').on('click', '.nasa-current-lang', function(e) {
 ...
 * Change Currencies
 */
$('body').on('click', '.wcml-cs-item-toggle', function(e) {
