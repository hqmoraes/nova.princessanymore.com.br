...
$(window).on('scroll', function() {
    ...
    if ($('.nasa-single-product-scroll').length) {
        ...
        if (!_responsive && !_inMobile) {
            ...
            // var _max_info_height = bodyHeight;
            ...
            if ($('.fixed-already').length === 1) {
                ...
                // _max_info_height = _max_info_height - _fixed_height;
            }

            if ($('#wpadminbar').length === 1) {
                var _admbar_height = $('#wpadminbar').outerHeight();
                _topfix += _admbar_height;
                // _max_info_height = _max_info_height - _admbar_height;
            }
            ...
            // _info_height = _info_height < _max_info_height ? _info_height : _max_info_height;
            
            var _thumb_height = _hasThumbs ? $('.nasa-single-product-thumbnails').height() : 0;
            // _thumb_height = _thumb_height < _max_info_height ? _thumb_height : _max_info_height;
